...
# and merged the files to a new merged one #   
#                                          #
# -----------------------------------------#                                        
...
print(today_date)
  ...
  for msg in messages:
    ...
    if search_subject_str in m_subject and search_sender_str in m_sender and m_received_date == today_date:
        ...
        attachment_name_change= attachment_name[0:-5] + "_" +str(today_date) + '.xlsx'
...
excl_merged.to_excel(f'C:\\Users\\aov\\Desktop\\ResponsysAutomation\\ExcelMerge\\mail\\Suncorp_merged_{today_date}.xlsx', index=False)